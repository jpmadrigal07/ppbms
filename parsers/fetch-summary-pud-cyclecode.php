...
$sql = "SELECT DISTINCT(record_cycle_code), record_pud FROM ppbms_record WHERE record_year = '$year' AND  record_month = '$month' AND record_sender = '$sender' AND record_deltype = '$deltype'";  
$result = mysqli_query($db_conn, $sql);  

  $output .= '
  <form method="post" action="reportsummary.php">
