...
$count = 0; 
    ...
    $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND messenger_id = '".$_POST["messengerid"]."' AND record_cycle_code = '".$_POST["cyclecode"]."' AND record_status = '' ORDER BY id $limit";  
