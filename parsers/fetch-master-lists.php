...
if($_POST["filter"] == "all") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND (record_subs_name LIKE '%".$_POST["search"]."%' OR record_cycle_code LIKE '%".$_POST["search"]."%' OR record_bar_code LIKE '%".$_POST["search"]."%' OR record_deltype LIKE '%".$_POST["search"]."%' OR record_sender LIKE '%".$_POST["search"]."%') ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
} else if($_POST["filter"] == "cyclecode") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND record_cycle_code LIKE '%".$_POST["search"]."%' ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
} else if($_POST["filter"] == "barcode") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND record_bar_code LIKE '%".$_POST["search"]."%' ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
} else if($_POST["filter"] == "deltype") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND record_deltype LIKE '%".$_POST["search"]."%' ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
} else if($_POST["filter"] == "sender") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND record_sender LIKE '%".$_POST["search"]."%' ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
} else if($_POST["filter"] == "name") {  
  $sql = "SELECT * FROM ppbms_record WHERE record_status_status = '1' AND encode_lists_id = '".$_POST["encodeid"]."' AND record_subs_name LIKE '%".$_POST["search"]."%' ORDER BY id $limit";  
  $result = mysqli_query($db_conn, $sql);  
}
