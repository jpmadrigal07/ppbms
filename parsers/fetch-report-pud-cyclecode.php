...
$sql = "SELECT DISTINCT(record_cycle_code), record_pud FROM ppbms_record WHERE record_status_status = '1' AND record_year = '$year' AND  record_month = '$month' AND record_sender = '$sender' AND record_deltype = '$deltype' ORDER BY record_cycle_code";  
$result = mysqli_query($db_conn, $sql);  

  $output .= '
  <form method="post" action="tryallinone.php">
