...
<html lang="en">
  <head>
    ...
    <title>PPBMS - Receipt (Not Assigned)</title>
    <!-- FavIcon -->
  ...
  <body>
     ...
     <div class="container-fluid">
            ...
            <?php
                $sql = "SELECT id, record_cycle_code, record_sender, record_subs_name, record_bar_code, record_area, record_address, record_deltype, record_pud, record_job_num, record_seq_num FROM ppbms_record WHERE encode_lists_id = '$encodeid' AND messenger_id = '0' AND record_status_status = '1'";
