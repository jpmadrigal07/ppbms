...
<html lang="en">
  <head>
    ...
    <title>PPBMS - Dispatch Control (Proof)</title>
    <!-- FavIcon -->
  ...
  <body>
     ...
     <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <center><h4><b>PROOF OF PRODUCT RETURN</b></h4></center>
            </div>
         </div>
         <table class="table table-bordered">
            <thead>
            <tr>
                <th rowspan="4" style="padding-bottom: 10px;"><center>QUANTITY</center></th>
                <th rowspan="4" style="padding-bottom: 10px;"><center>CYCLECODE/PICK-UP</center></th>
                <th rowspan="4" style="padding-bottom: 10px;"><center>PRODUCT DESCRIPTION</center></th>
                <th colspan="5"><center>DATE RETURNED</center></th>
            </tr>
            <tr>
                <th><center style='visibility: hidden;'>00000</center></th>
                <th><center style='visibility: hidden;'>00000</center></th>
                <th><center style='visibility: hidden;'>00000</center></th>
                <th><center style='visibility: hidden;'>00000</center></th>
                <th><center style='visibility: hidden;'>00000</center></th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><center><?php echo $cyclecode1; ?><?php if($cyclecode1 != "") { echo '/'; }; ?><?php if($pickupdate1 != "") echo date("M d, Y", strtotime($pickupdate1)); ?></center></td>
                    <td><center><?php echo $sender1.' '.$deltype1; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode2; ?><?php if($cyclecode2 != "") { echo '/'; }; ?><?php if($pickupdate2 != "") echo date("M d, Y", strtotime($pickupdate2)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode3; ?><?php if($cyclecode3 != "") { echo '/'; }; ?><?php if($pickupdate3 != "") echo date("M d, Y", strtotime($pickupdate3)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode4; ?><?php if($cyclecode4 != "") { echo '/'; }; ?><?php if($pickupdate4 != "") echo date("M d, Y", strtotime($pickupdate4)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode5; ?><?php if($cyclecode5 != "") { echo '/'; }; ?><?php if($pickupdate5 != "") echo date("M d, Y", strtotime($pickupdate5)); ?></center></td>
                    <td><center><?php echo $sender5.' '.$deltype5; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode6; ?><?php if($cyclecode6 != "") { echo '/'; }; ?><?php if($pickupdate6 != "") echo date("M d, Y", strtotime($pickupdate6)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode7; ?><?php if($cyclecode7 != "") { echo '/'; }; ?><?php if($pickupdate7 != "") echo date("M d, Y", strtotime($pickupdate7)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode8; ?><?php if($cyclecode8 != "") { echo '/'; }; ?><?php if($pickupdate8 != "") echo date("M d, Y", strtotime($pickupdate8)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode9; ?><?php if($cyclecode9 != "") { echo '/'; }; ?><?php if($pickupdate9 != "") echo date("M d, Y", strtotime($pickupdate9)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode10; ?><?php if($cyclecode10 != "") { echo '/'; }; ?><?php if($pickupdate10 != "") echo date("M d, Y", strtotime($pickupdate10)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode11; ?><?php if($cyclecode11 != "") { echo '/'; }; ?><?php if($pickupdate11 != "") echo date("M d, Y", strtotime($pickupdate11)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode12; ?><?php if($cyclecode12 != "") { echo '/'; }; ?><?php if($pickupdate12 != "") echo date("M d, Y", strtotime($pickupdate12)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode13; ?><?php if($cyclecode13 != "") { echo '/'; }; ?><?php if($pickupdate13 != "") echo date("M d, Y", strtotime($pickupdate13)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode14; ?><?php if($cyclecode14 != "") { echo '/'; }; ?><?php if($pickupdate14 != "") echo date("M d, Y", strtotime($pickupdate14)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode15; ?><?php if($cyclecode15 != "") { echo '/'; }; ?><?php if($pickupdate15 != "") echo date("M d, Y", strtotime($pickupdate15)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode16; ?><?php if($cyclecode16 != "") { echo '/'; }; ?><?php if($pickupdate16 != "") echo date("M d, Y", strtotime($pickupdate16)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode17; ?><?php if($cyclecode17 != "") { echo '/'; }; ?><?php if($pickupdate17 != "") echo date("M d, Y", strtotime($pickupdate17)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode18; ?><?php if($cyclecode18 != "") { echo '/'; }; ?><?php if($pickupdate18 != "") echo date("M d, Y", strtotime($pickupdate18)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode19; ?><?php if($cyclecode19 != "") { echo '/'; }; ?><?php if($pickupdate19 != "") echo date("M d, Y", strtotime($pickupdate19)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode20; ?><?php if($cyclecode20 != "") { echo '/'; }; ?><?php if($pickupdate20 != "") echo date("M d, Y", strtotime($pickupdate20)); ?></center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode21; ?><?php if($cyclecode21 != "") { echo '/'; }; ?><?php if($pickupdate21 != "") echo date("M d, Y", strtotime($pickupdate21)); ?></center></td>
                    <td><center><?php echo $sender21.' '.$deltype21; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode22; ?><?php if($cyclecode22 != "") { echo '/'; }; ?><?php if($pickupdate22 != "") echo date("M d, Y", strtotime($pickupdate22)); ?></center></td>
                    <td><center><?php echo $sender22.' '.$deltype22; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode23; ?><?php if($cyclecode23 != "") { echo '/'; }; ?><?php if($pickupdate23 != "") echo date("M d, Y", strtotime($pickupdate23)); ?></center></td>
                    <td><center><?php echo $sender23.' '.$deltype23; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    ...
                    <td><center><?php echo $cyclecode24; ?><?php if($cyclecode24 != "") { echo '/'; }; ?><?php if($pickupdate24 != "") echo date("M d, Y", strtotime($pickupdate24)); ?></center></td>
                    <td><center><?php echo $sender24.' '.$deltype24; ?></center></td>
                    <!-- date returned -->
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                    <td><center style='visibility: hidden;'>00000</center></td>
                ...
                <tr>
                    <td style='visibility: hidden;'><center>00000</center></td>
                    <td style='visibility: hidden;'><center>00000</center></td>
         ...
         <div class="row">
          <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                <p style="margin-bottom: 0px;">DATE PICK UP: <b><?php echo $dispatchcontrolnewdate; ?></b></p>
                <p style="margin-bottom: 0px;">DUE DATE: ___________________</p><br>
          </div>
          <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <p style="margin-bottom: 0px;">TOTAL VOLUME DISPATCH: <b><?php echo $grandTotal; ?></b></p>
                <p style="margin-bottom: 0px;">TOTAL VOLUME RETURNED: ___________________</p>
          </div>
         </div>
         <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <p style="text-align: right;"><b>No. PPB - <?php echo date("Y");?><?php echo $messengerid;?></b></p>
          </div>
         </div>
         <div class="row">
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
