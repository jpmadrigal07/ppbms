...
if(isset($_GET["messengerid"]) && isset($_GET["cyclecode"])){
...
<html lang="en">
  <head>
    ...
    <title>PPBMS - Receipt (Not Received)</title>
    <!-- FavIcon -->
  ...
  <body>
     ...
     <div class="container-fluid">
            ...
            <?php
                $sql = "SELECT id, record_cycle_code, record_sender, record_subs_name, record_bar_code, record_area, record_address, record_deltype, record_pud, record_job_num, record_seq_num FROM ppbms_record WHERE messenger_id = '$messengerid' AND record_cycle_code = '$cyclecode' AND record_status = '' AND record_status_status = '1'";
