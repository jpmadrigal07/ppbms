...
function __backup_mysql_database($params)
{
    ...
    if (!is_dir ( $params['db_backup_path'].'/'.$dateNow )) {
            mkdir ( $params['db_backup_path'].'/'.$dateNow, 0777, true );
     }
    
    $backup_file_name = $params['db_backup_path']."/".$dateNow."/sql-backup-".$dateNow.".sql";
...
$para = array(
    ...
    'db_uname' => 'root',  //user
    'db_password' => '', //pass
    'db_to_backup' => 'ppbms', //database name
